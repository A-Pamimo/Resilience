...
# multiple cores).
source('C:\Users\olanrewaju\Downloads\SPEIbase-master\R\functions.R')
...
for (i in c(1:48)) {#  for (i in c(6)) {
    spei.nc(
      sca=i,
		  inPre='C:\Users\olanrewaju\Downloads\SPEIbase-master\inputData\cru_ts4.08.1901.2023.pre.dat.nc',
		  inEtp= 'C:\Users\olanrewaju\Downloads\SPEIbase-master\inputData\cru_ts4.08.1901.2023.pet.dat.nc',
